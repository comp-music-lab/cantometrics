...
nominal<-c(1:4,7,11:16,22)
ordinal<-c(5:6,9:10,17:21,23:37) #NB: line 8 is excluded because it was dropped from 1976 - was just here as a placeholder column
...
write.csv(as.matrix(dist),"CantometricsDistNominal.csv")
